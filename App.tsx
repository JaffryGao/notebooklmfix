...
const App: React.FC = () => {
  ...
  const handleSelectKey = async () => {
    // Check if we are in Project IDX or similar environment with aistudio injected
    if (typeof window.aistudio !== 'undefined' && window.aistudio.openSelectKey) {
      await promptForKeySelection();
      setKeyAuthorized(true);
    } else {
      // Local environment: Open manual input modal
        ...
        {pages.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pb-20">
            {pages.map((page, idx) => (
              <div
                key={idx}
                className={`relative group bg-white dark:bg-zinc-900 border rounded-2xl overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-black/10 dark:hover:shadow-black/20 ${currentProcessingIndex === idx
          ...
          <div className="pointer-events-auto max-w-2xl w-full bg-white dark:bg-zinc-900 border border-emerald-500/30 shadow-2xl shadow-emerald-500/20 rounded-2xl p-4 md:p-5 flex flex-col md:flex-row items-center justify-between gap-4 animate-in slide-in-from-bottom-10 fade-in duration-500">
            ...
            <div className="flex items-center gap-3 w-full md:w-auto">
              ...
              <button
                ...
                className={`flex-1 md:flex-none flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border font-medium transition-all ${isExportingPdf
                  ? "bg-indigo-50 dark:bg-indigo-500/10 border-indigo-200 dark:border-indigo-500/30 text-indigo-600 dark:text-indigo-400 cursor-wait"
              ...
              <button
                ...
                className={`flex-1 md:flex-none flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border font-medium transition-all ${isExportingPptx
                  ? "bg-orange-50 dark:bg-orange-500/10 border-orange-200 dark:border-orange-500/30 text-orange-600 dark:text-orange-400 cursor-wait"
                  : "bg-white dark:bg-white/5 border-zinc-200 dark:border-white/10 text-zinc-700 dark:text-zinc-200 hover:bg-zinc-50 dark:hover:bg-white/10 hover:border-zinc-300 dark:hover:border-white/20 shadow-sm"
                  }`}
              >
          ...
          <div className="flex-1 relative flex items-center justify-center p-4 overflow-hidden select-none">
            ...
            >
              ...
              <img
                ...
                className={`max-w-full max-h-[90vh] w-auto h-auto object-contain rounded-lg transition-opacity duration-100 absolute inset-0 z-10 ${isHoldingCompare ? 'opacity-100' : 'opacity-0'}`}
                alt="Original"
              />
              ...
              <img
                ...
                className="max-w-full max-h-[90vh] w-auto h-auto object-contain rounded-lg relative z-0"
                alt="Processed"
              />
